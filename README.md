...
💰 **Inline Price Overlay** — Floating bar on store pages shows the best price across all stores

🏆 **Deal Score (0-100)** — Smart rating based on discount depth, historical low, and price trends

📊 **Smart Dashboard** — Shows price drops and historical lows for your wishlisted games

💜 **Wishlist & Alerts** — Track games and get notified when prices drop below your target

📦 **Bundle Finder** — Discover active bundles that include games you're browsing
